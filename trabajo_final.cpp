...
int main()
{
  ...
  // ejercicio h//
  cout << " Lista de venta por marcas: " << endl;

  for (int i = 0; i < 5; i++)
  {
    cout << " " << listado_de_marcas[i] << " ventas: " << (listado_de_precio_marca[i] / 4) << endl;
  }

  // ejercicio i//

  cout << " Lista de venta por tipos: " << endl;

  for (int i = 0; i < 3; i++)
  {
    cout << " " << listado_de_tipos[i] << " ventas: " << ((listado_de_precio_tipos[i] / 3)) << endl;
  }
